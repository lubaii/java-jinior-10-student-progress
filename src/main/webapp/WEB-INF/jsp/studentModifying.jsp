                ...
                <div id="containerForm" class="row">
                    ...
                    <form class="needs-validation was-validated"  method="post" action="/student-modify">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="surname" name="surname" value="${studs.lastname}" placeholder="Иванов" required>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="namep" name ="name" value="${studs.firstname}" placeholder="Иван" required>
                            </div>
                            <div class="valid-tooltip">Хорошо!</div>
                            <div class="invalid-tooltip">Заполните это поле!</div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="group1" name = "group" value="${studs.group}" placeholder="КТ-21" required>
                            </div>
                            <div class="valid-tooltip">Хорошо!</div>
                            <div class="invalid-tooltip">Заполните это поле!</div>
                        </div>
