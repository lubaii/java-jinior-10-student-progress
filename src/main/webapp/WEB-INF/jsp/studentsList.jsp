            ...
            <div id="divStudentsList1" class="row">
                <div class="col-sm-6">
                    <a onclick="progressStudentes()">
                        <button id="button1" type="button" class="btn btn-outline-secondary btn-lg btn-block">Посмотреть
                            успеваемость выбранного студента
                        </button>
                    </a>
                </div>
                ...
                <div class="col-sm-6">
                    <a href="/student-create">
                        <button type="button" class="btn btn-outline-secondary btn-lg btn-block">Создать студента
                        </button>
            ...
            <div id="divStudentsList2" class="row">
                ...
                <div class="col-sm-6">
                    <a onclick="deleteStudents()">
                        <button type="button" class="btn btn-outline-secondary btn-lg btn-block">Удалить выбранных
                            студентов
                        </button>
                    </a>
                </div>
...
<form id="formModiStudent" method="get" action="/student-modify">
    <input type="hidden" id="idModifyStuds" name="idModifyStuds"
